...
const Explore: React.FC = () => {
  ...
  // store currently hovered slide index
              ...
              <div className="lg:max-w-[950px] order-2 md:order-1">
                <div className="min-h-[300px]">
                  <h4
                    ...
                    data-aos="fade-up"
                  >
                    {hoveredIndex !== null ? slides[hoveredIndex].title : slides[0].title}
                  </h4>
                  <p
                    className="text-primary text-base md:text-lg xl:text-xl font-light leading-[140%] tracking-[-0.2px]"
                    data-aos="fade-up"
                  >
                    {hoveredIndex !== null ? slides[hoveredIndex].longDesc : slides[0].longDesc}
                  </p>
                </div>
              </div>
