...
const allSlides: SlideItem[] = [
    ...
    },
    {
        ...
        more: 'Polana Szymoszkowa to ośrodek narciarski i rekreacyjny położony w Zakopanem. Dysponuje nowoczesną infrastrukturą: dwiema kolejkami (6- i 4-osobową), trasami narciarskimi (1,7 km) oświetlonymi i sztucznie naśnieżanymi, Kids Parkiem dla najmłodszych oraz wypożyczalnią sprzętu. Latem można tu korzystać z kąpieliska geotermalnego (czynne od czerwca), basenu z widokiem na Tatry, zjeżdżalni i plażowych rozrywek. To miejsce, gdzie aktywny wypoczynek łączy się z malowniczymi panoramami — idealne na rodzinny dzień niezależnie od sezonu.',
        category: 'Wyciągi narciarskie',
    },
    {
        img: 'location-11.png',
    ...
    },
    {
        ...
        more: 'Karczma Pod Giewontem oferuje dania kuchni polskiej i podhalańskiej, z widokiem na Giewont i Tatry. W menu znajdziesz oscypki, kwaśnicę, pierogi oraz dania mięsne z grilla. Restauracja jest przystosowana dla rodzin, posiada kącik dla dzieci, a także przestronny taras z panoramą gór.',
        category: 'Restauracje',
    },
    {
        img: 'location-21.png',
    ...
    return (
        <section className="bg-white pt-[120px] md:pt-[100px] lg:pt-[176px] pb-[52px] sm:pb-[70px] md:pb-[100px] xl:pb-[148px]">
            <div className="container">
                ...
                <div className="pt-[50px] md:pt-[70px] lg:pt-[100px] xl:pt-[110px] flex flex-col lg:flex-row lg:items-start lg:justify-between" data-aos="fade-up">
                            ...
                            {categories.map((cat) => (
                                <li key={cat}>
                                    <button
                                        ...
                                        className={`text-lg 2xl:text-xl font-normal leading-[170%] transition-all hover:text-brown flex items-center gap-2 cursor-pointer ${
                                            selectedCategory === cat ? 'text-brown font-medium' : 'text-black'
                                        }`}
                                    >
                    ...
                    <div className="w-full lg:w-[80%] relative mt-[50px] lg:mt-0">
                        <Swiper
                                ...
                                <SwiperSlide key={index}>
                                    <div>
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div
                                                className={`more_text ${
                                                    openSlides[index] ? 'max-h-[500px]' : 'max-h-0'
