                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        <div className="relative pb-6 md:pb-8 lg:pb-6 xl:pb-[42px] after:w-[205%] after:h-[1px] after:block after:bg-black after:absolute after:bottom-0 after:left-0">
                            <p className="text-black text-base md:text-xl lg:text-base 2xl:text-xl font-light leading-[120%] tracking-[-0.14px] uppercase mb-5 md:mb-8 lg:mb-5 xl:mb-10" data-aos="fade-up">
                                Wyjątkowe miejsce na udany wypoczynek{' '}
                                <strong className="font-bold">w witowie na podhalu</strong>
                            </p>
                            <h1 className="text-[#8E6565] text-[32px] md:text-[40px] lg:text-[42px] xl:text-[62px] 2xl:text-[72px] font-normal leading-[111.111%] tracking-[-1px]" data-aos="fade-up">
                                Family House
                            </h1>
                        </div>
                        ...
                        <div className="max-w-[620px] w-full lg:pr-[30px] 2xl:pr-0 pt-8">
                            <h2 className="text-black text-xl 2xl:text-2xl font-work-sans font-medium leading-[137.5%] tracking-[0.24px]" data-aos="fade-up">
                                O nas
                            </h2>
                            <p className="text-primary text-base md:text-lg lg:text-base xl:text-lg 2xl:text-xl font-normal leading-[150%] mt-5 xl:mt-[30px]" data-aos="fade-up">
                            ...
                            <p className="text-primary text-base md:text-lg lg:text-base xl:text-xl font-normal leading-[150%] mt-5 xl:mt-[30px]" data-aos="fade-up">
                    ...
                    {/* About Right Column */}
                    <div className="w-full lg:w-1/2 lg:pl-[40px] xl:pl-0 mt-[50px] lg:mt-0" data-aos="zoom-in-left">
                        <Image
